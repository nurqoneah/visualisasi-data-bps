...
from provinsi.sum import plotly_visual,data_processing
...
def add_sum_callbacks(app: dash.Dash): 
    @app.callback(
        Output('sum_pie_chart_fig', 'figure'),
        [Input('sum_value_type_options', 'value')],
        [Input('sub_categories_menu', 'value'),
        Input('year_dropdown', 'value'),
        Input('sum_chart_type_options', 'value')]  
    )
    ...
    @app.callback(
        Output('sum_heatmap_fig', 'figure'),
        [Input('sum_turunan_variabel_dropdown_heatmap', 'value'),
         Input('sub_categories_menu', 'value')],
         Input('year_dropdown', 'value')
    )
    ...
    @app.callback(
        Output('sum_bar_chart_fig', 'figure'),
        [Input('sum_value_type_options_bar', 'value')],
        [Input('sub_categories_menu', 'value'),
        Input('year_dropdown', 'value'),
        Input('sum_chart_type_options_bar', 'value')]  
    )
    ...
    @app.callback(
        Output('sum_time_series_fig', 'figure'),
        [Input('sum_turunan_variabel_dropdown_time_series', 'value'),
        Input('sum_variables_multi_select', 'value'),  
        Input('sub_categories_menu', 'value')]
    )
